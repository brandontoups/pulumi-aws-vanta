...
namespace Pulumi.vanta
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.vanta.version.txt");
    ...
    internal sealed class vantaResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public vantaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
