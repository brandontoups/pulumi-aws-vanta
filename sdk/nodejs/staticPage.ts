...
export class StaticPage extends pulumi.ComponentResource {
  /** @internal */
  public static readonly __pulumiType = "vanta:index:StaticPage";
   ...
   * The bucket resource.
   */
  public readonly /*out*/ bucket!: pulumi.Output<aws.s3.Bucket>;
  /**
   * The website URL.
   */
  public readonly /*out*/ websiteUrl!: pulumi.Output<string>;
